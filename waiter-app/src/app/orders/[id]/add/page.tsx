...
export default function AddItemsPage() {
  ...
  const handleSubmit = async () => {
    ...
    // Prepare Items to insert into existing order
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-32">
      <header className="sticky top-0 z-10 bg-white p-4 shadow-sm flex items-center gap-4">
        <Link href={`/orders/${orderId}`} className="text-gray-500 hover:text-orange-500">
          <ArrowLeft size={24} />
        </Link>
        <h1 className="text-xl font-bold text-gray-800">Добавить блюда</h1>
      </header>
